...
void rtlSetup() {
  ...
  if (!cfg->demod) {
    ...
    if (rtl_433_ESP::ookModulation) {
      ...
      memcpy(&cfg->devices[26], &fineoffset_wh55, sizeof(r_device));
      memcpy(&cfg->devices[27], &fineoffset_wn34, sizeof(r_device));
      memcpy(&cfg->devices[28], &fineoffset_ws80, sizeof(r_device));
      memcpy(&cfg->devices[29], &fineoffset_ws90, sizeof(r_device));
      memcpy(&cfg->devices[30], &flowis, sizeof(r_device));
      memcpy(&cfg->devices[31], &ge_coloreffects, sizeof(r_device));
      memcpy(&cfg->devices[32], &geo_minim, sizeof(r_device));
      memcpy(&cfg->devices[33], &hcs200_fsk, sizeof(r_device));
      memcpy(&cfg->devices[34], &holman_ws5029pcm, sizeof(r_device));
      memcpy(&cfg->devices[35], &holman_ws5029pwm, sizeof(r_device));
      memcpy(&cfg->devices[36], &hondaremote, sizeof(r_device));
      memcpy(&cfg->devices[37], &honeywell_cm921, sizeof(r_device));
      memcpy(&cfg->devices[38], &honeywell_wdb_fsk, sizeof(r_device));
      memcpy(&cfg->devices[39], &ikea_sparsnas, sizeof(r_device));
      memcpy(&cfg->devices[40], &inkbird_ith20r, sizeof(r_device));
      memcpy(&cfg->devices[41], &insteon, sizeof(r_device));
      memcpy(&cfg->devices[42], &lacrosse_breezepro, sizeof(r_device));
      memcpy(&cfg->devices[43], &lacrosse_r1, sizeof(r_device));
      memcpy(&cfg->devices[44], &lacrosse_th3, sizeof(r_device));
      memcpy(&cfg->devices[45], &lacrosse_tx31u, sizeof(r_device));
      memcpy(&cfg->devices[46], &lacrosse_tx34, sizeof(r_device));
      memcpy(&cfg->devices[47], &lacrosse_tx29, sizeof(r_device));
      memcpy(&cfg->devices[48], &lacrosse_tx35, sizeof(r_device));
      memcpy(&cfg->devices[49], &lacrosse_wr1, sizeof(r_device));
      memcpy(&cfg->devices[50], &m_bus_mode_c_t, sizeof(r_device));
      memcpy(&cfg->devices[51], &m_bus_mode_c_t_downlink, sizeof(r_device));
      memcpy(&cfg->devices[52], &m_bus_mode_s, sizeof(r_device));
      memcpy(&cfg->devices[53], &m_bus_mode_r, sizeof(r_device));
      memcpy(&cfg->devices[54], &m_bus_mode_f, sizeof(r_device));
      memcpy(&cfg->devices[55], &marlec_solar, sizeof(r_device));
      memcpy(&cfg->devices[56], &maverick_xr30, sizeof(r_device));
      memcpy(&cfg->devices[57], &oil_smart, sizeof(r_device));
      memcpy(&cfg->devices[58], &oil_standard, sizeof(r_device));
      memcpy(&cfg->devices[59], &oil_watchman, sizeof(r_device));
      memcpy(&cfg->devices[60], &oil_watchman_advanced, sizeof(r_device));
      memcpy(&cfg->devices[61], &rojaflex, sizeof(r_device));
      memcpy(&cfg->devices[62], &sharp_spc775, sizeof(r_device));
      memcpy(&cfg->devices[63], &simplisafe_gen3, sizeof(r_device));
      memcpy(&cfg->devices[64], &somfy_iohc, sizeof(r_device));
      memcpy(&cfg->devices[65], &srsmith_pool_srs_2c_tx, sizeof(r_device));
      memcpy(&cfg->devices[66], &steelmate, sizeof(r_device));
      memcpy(&cfg->devices[67], &tfa_14_1504_v2, sizeof(r_device));
      memcpy(&cfg->devices[68], &tfa_303196, sizeof(r_device));
      memcpy(&cfg->devices[69], &tfa_marbella, sizeof(r_device));
      memcpy(&cfg->devices[70], &tpms_abarth124, sizeof(r_device));
      memcpy(&cfg->devices[71], &tpms_ave, sizeof(r_device));
      memcpy(&cfg->devices[72], &tpms_citroen, sizeof(r_device));
      memcpy(&cfg->devices[73], &tpms_elantra2012, sizeof(r_device));
      memcpy(&cfg->devices[74], &tpms_ford, sizeof(r_device));
      memcpy(&cfg->devices[75], &tpms_hyundai_vdo, sizeof(r_device));
      memcpy(&cfg->devices[76], &tpms_jansite, sizeof(r_device));
      memcpy(&cfg->devices[77], &tpms_jansite_solar, sizeof(r_device));
      memcpy(&cfg->devices[78], &tpms_kia, sizeof(r_device));
      memcpy(&cfg->devices[79], &tpms_nissan, sizeof(r_device));
      memcpy(&cfg->devices[80], &tpms_pmv107j, sizeof(r_device));
      memcpy(&cfg->devices[81], &tpms_porsche, sizeof(r_device));
      memcpy(&cfg->devices[82], &tpms_renault, sizeof(r_device));
      memcpy(&cfg->devices[83], &tpms_renault_0435r, sizeof(r_device));
      memcpy(&cfg->devices[84], &tpms_toyota, sizeof(r_device));
      memcpy(&cfg->devices[85], &tpms_truck, sizeof(r_device));
    }
